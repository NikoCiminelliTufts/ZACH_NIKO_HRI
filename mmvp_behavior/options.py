...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--data_dir', default='/media/ramtin/ramtin/data/CY101NPY', help='directory containing data.')
        ...
        self.parser.add_argument('--sequence_length', type=int, default=10, help='sequence length, including context frames.') # this is specifically for prediction
        ...
        self.parser.add_argument('--dna_kern_size', type=int, default=5, help='CDNA_KERN_SIZE.')
        ...
        self.parser.add_argument('--batch_size', type=int, default=32, help='batch size for training') # minibatch size given to the dataloader as well as pytorch
